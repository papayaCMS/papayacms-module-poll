...
* @version $Id: content_poll.php 39287 2014-02-19 21:34:07Z weinert $
*/
  ...
  */
  function getPollCombo($name, $field, $data) {
    ...
    if (isset($this->pollObject->categs) && is_array($this->pollObject->categs)) {
      foreach ($this->pollObject->categs as $categ) {
        ...
        if (isset($this->pollObject->polls) &&
          ...
          foreach ($this->pollObject->polls as $poll) {
